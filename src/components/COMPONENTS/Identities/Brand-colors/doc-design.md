...
Les couleurs de marques permettent de représenter les **marques** portées par Sipa.

## Usage

Ces couleurs n’ont pas d’usage particulier, elles découlent de la charte graphique propre à chaque marque.
...
### Couleurs d’un thème
- Les couleurs liées au thème de SipaUI sont disponibles dans le [doc design du composant Colors](/storybook/?path=/story/utilities-colors--design) de Utilities.
