...
**Étape 1** | ![abonnement__mobile__step__1](design/abonnement__mobile__step__1.png)
------------ | -------------
**Étape 2** | ![abonnement__mobile__step__2](design/abonnement__mobile__step__2.png)
**Étape 3** | ![abonnement__mobile__step__3](design/abonnement__mobile__step__3.png)

#### Mobile - Thème Ouest-France

**Étape 1** | ![without-label__step__1](design/without-label__step__1.png)
------------ | -------------
**Étape 2** | ![without-label__step__2](design/without-label__step__2.png)
**Étape 3** | ![without-label__step__3](design/without-label__step__3.png)

#### Desktop - Thème Ouest-France

**Étape 1** | ![default__step__1](design/default__step__1.png)
------------ | -------------
**Étape 2** | ![default__step__2](design/default__step__2.png)
**Étape 3** | ![default__step__3](design/default__step__3.png)
