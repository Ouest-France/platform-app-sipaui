        ...
        <main class="su-old-editorial su-padding-b-standard" role="main">
            <article class="presentation su-margin-bottom-xl" role="article">
                <div class="conteneur">
                    <div class="titre">
                        <h1>SipaUI</h1>
                        <span class="version">0.4.3</span>
                    </div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 500 565" class="illustration su-block-center su-margin-bottom-m">
                    ...
                    <p class="baseline su-margin-bottom-xl">Framework frontend (CSS et JS) de composants graphiques et de styles éditoriaux pour les sites du Groupe SIPA-Ouest‑France.</p>
                    <section class="intro su-text-justify">
