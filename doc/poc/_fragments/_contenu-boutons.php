<article class="conteneur" role="article">
                ...
                <ul class="liste-boutons">
                    <li><h3 class="titre-doc">Bouton <code>basic</code></h3>
                        ...
                        <div class="su-margin-b-small">
                            <input class="su-button" type="button" value="Bouton &lt;input&gt;">
                        </div>
                ...
                <ul class="liste-boutons">
                    <li>Bouton <code>basic</code>
                        <div>
                            <a class="su-button" href="#">small</a>
                        </div>
                    </li>
                    <li>Bouton <code>basic</code>
                        <div>
                            <a class="su-button" href="#">medium</a>
                        </div>
                    </li>
                    <li>Bouton <code>basic</code>
                        <div>
                            <a class="su-button" href="#">big</a>
                        </div>
                    </li>
                </ul>

                <h2 class="titre-doc">Fluides</h2>
                <ul class="su-not-list su-margin-b-standard liste-boutons">
